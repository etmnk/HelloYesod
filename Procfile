...
#     echo '{ "name": "HelloYesod", "version": "0.0.1", "dependencies": {} }' >> package.json
#
...
#
#     git checkout deploy
#     git add ./dist/build/HelloYesod/HelloYesod
#     git commit -m deploy
#
# * push to Heroku
#
...
web: ./dist/build/HelloYesod/HelloYesod production -p $PORT
